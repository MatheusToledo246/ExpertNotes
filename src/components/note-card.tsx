    ...
    return (
        <div className="rounded-md bg-slate-800 p-5 space-y-3 overflow-hidden relative outline-none hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400">
            ...
            <p className="text-sm leading-6 text-slate-400">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Iure porro repellendus molestias earum. Repellat incidunt magnam cupiditate dolorem perferendis at officia, omnis, necessitatibus, saepe eveniet voluptas earum quo doloremque eius?
             </p>
